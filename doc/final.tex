...
Although bottom-up synthesis (citation?) are often inductive and example-based, we use a deductive approach that is based on under-approximate type-checking to ensure correctness of the synthesized program.
